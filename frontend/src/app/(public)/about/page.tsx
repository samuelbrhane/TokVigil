...
const values = [
  {
    title: "SDK-first",
    description:
      "Control belongs in your code, not in a separate dashboard you check once a month. Developers integrate TokenFence in 3 lines policies enforce automatically from there.",
  },
  {
  ...
  },
  {
    ...
    description:
      "TokenFence exists because teams shipping AI in production kept solving the same problems rate limits, cost spikes, per-user tracking. We built the tool we needed.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="space-y-6 text-surface-400 leading-relaxed">
              <p>
                TokenFence is an application-layer control plane that helps
              ...
              <p>
                ...
                reliably enforce business logic. TokenFence does.
              </p>
              <p>
