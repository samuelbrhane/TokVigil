...
const sections = [
  {
    ...
    content:
      "By accessing or using TokVigil, you agree to be bound by these Terms of Service. If you do not agree, do not use the platform. These terms apply to all users, including developers integrating our SDKs and dashboard users.",
  },
  {
    title: "2. Description of Service",
    content:
      "TokVigil is an application-layer AI usage control platform. We provide APIs, SDKs (Python and TypeScript), a VS Code extension, and a web dashboard that allow developers to enforce usage policies, rate limits, and budgets on AI calls within their applications. TokVigil does not provide AI models, does not process or store LLM prompts or responses, and does not act as a proxy between your application and AI providers.",
  },
  {
  ...
  },
  {
    ...
    content:
      "We aim for high availability but do not guarantee uninterrupted service on Free, Pro, or Premium plans. Enterprise plans include SLA terms defined in separate agreements. Our SDKs include graceful degradation — if the TokVigil API is unreachable, you can configure your application to allow or block requests by default.",
  },
  {
    title: "9. Intellectual Property",
    content:
      "TokVigil and its associated SDKs, documentation, and branding are our intellectual property. You retain full ownership of your application code, policies, and usage data. Our SDKs are provided under open-source licenses as specified in their respective repositories.",
  },
  {
    title: "10. Limitation of Liability",
    content:
      'TokVigil is provided "as is" without warranties of any kind, express or implied. We are not liable for any indirect, incidental, or consequential damages arising from your use of the platform. Our total liability is limited to the amount you paid us in the 12 months preceding the claim. We are not responsible for costs incurred from AI provider usage, even if our policy evaluation incorrectly allows a request.',
  },
  {
  ...
  },
  {
    title: "13. Contact",
    content:
      "For questions about these terms, contact us at support@tokvigil.com.",
  },
];
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-10">
            <p className="text-surface-400 leading-relaxed">
              ...
              TokVigil, operated by TokVigil (&quot;we&quot;, &quot;our&quot;,
