...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-brand-500 text-surface-950 font-bold hover:bg-brand-400 hover:shadow-[0_0_30px_rgba(6,182,212,0.3)]",
  secondary:
    "bg-surface-800/80 text-white border border-surface-700/50 hover:border-brand-500/40 hover:text-brand-300",
  ghost: "text-surface-300 hover:text-brand-300",
  danger:
