...
print("=" * 60)
print("TEST 9: Usage by Feature")
print("=" * 60)
by_feature = tf.get_usage_by_feature()
print("Usage by feature:")
for feat in by_feature.items[:5]:
    print(f"  {feat.group}: {feat.requests} requests")
print()

print("=" * 60)
print("TEST 10: Recent Usage")
print("=" * 60)
recent = tf.get_recent_usage(page=1, page_size=5)
print(f"Total records: {recent.total}")
print(f"Page: {recent.page}/{recent.total_pages}")
print(f"Has next: {recent.has_next}")
...
print("=" * 60)
print("TEST 11: Blocked Requests")
print("=" * 60)
blocked = tf.get_blocked_requests(page=1, page_size=5)
...
print("=" * 60)
print("TEST 12: Recent Usage with Filters")
print("=" * 60)
filtered = tf.get_recent_usage(page=1, page_size=5, user_id="user_123")
print(f"Records for user_123: {filtered.total}")
print()
